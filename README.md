...
This is a data collection and pre-processing exercise.
Our project is based on two synthetic data files. 
Using the widely adopted and powerful NumPy and pandas technology stack, we perform data loading, cleaning, and aggregation on these datasets.
